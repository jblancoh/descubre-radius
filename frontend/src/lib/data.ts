...
const Solutions = {
  "analytics": {
    "bgImg": "/img/bg/bg-soluciones.png",
    "cards": [{
  ...
  "tech": {
    ...
    "cards": [{
      "title": "Data Solutions",
      "imgSrc": "/img/data-solutions-blue.png",
      "description": [
        {
          "title": "Data Architecture",
          "content": "Es la práctica de recopilar, organizar y acceder a los datos garantizando su accesibilidad, seguridad y privacidad para dar soporte a la productividad, eficiencia y toma de decisiones."
    ...
    {
      "title": "Analytics Solutions",
      "imgSrc": "/img/tech-solutions-blue.png",
      "description": [
        {
          "title": "Automatizaión de Procesos",
          "content": ""
        },
        {
          "title": "Digitalización, Sistematización de Datos",
          "content": ""
        },
        {
    ...
    {
      "title": "Consulting Services",
      "imgSrc": "/img/consulting-services-blue.png",
      "description": [
        {
