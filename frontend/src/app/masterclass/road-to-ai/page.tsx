    ...
    <div>
     ...
     <section
      ...
      >
        ...
        <div className="flex flex-col items-start py-24 px-8 md:p-10 lg:p-12 max-w-4xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white font-archia text-2xl text-left">
              Train managers on how to develop a strategic vision for the implementation of AI in the organization, lead digital transformation through AI and take informed investment and asset management decisions on AI projects.
            </p>
            <div className="flex items-center space-x-2 justify-start"> {/* Cambia justify-center a justify-start */}
  <span className="text-xs font-light text-white border border-white px-2 rounded-md">
    Topics
  </span>
</div>
            ...
            <ul className="list-disc pl-5 space-y-1 text-white font-open-sans text-lg">
              <li>Train managers on how to develop a vision</li>
              <li>Strategic for the implementation of AI in the organización</li>
              <li>Lead digital transformation through AI and take</li>
              <li>Informed investment and asset management decisions</li>
              <li>AI projects</li>
            </ul>
          </div>
          ...
          <div className="bg-[#181818] p-6 rounded-lg space-y-4">
            ...
            <p className="text-white font-open-sans text-lg">
              He is an expert in digital transformation, design and creation of centers of excellence, implementation of agile frameworks, prioritization models and strategic alignment, as well as generating value for the business.
            </p>
            <p className="text-white font-open-sans text-lg">
              He has extensive experience in generating Data Products, Analytical Services and Digital Products in the telecommunications, retail and banking industries.
            </p>
          </div>
        </div>
      </section>
