    ...
    <div className=" bg-tech-400 flex flex-col items-center space-y-4">
      ...
      <div className="grid grid-cols-4 gap-4 container pb-8">
        <div className="col-span-4 md:col-span-1">
          <Card className="rounded-none border-0 hover:-translate-y-1 duration-300 md:h-[500px] ">
        ...
        <div className="col-span-4 md:col-span-1">
          <Card className="rounded-none border-0 hover:-translate-y-1 duration-300 md:h-[500px]">
            ...
            <CardFooter className="md:absolute md:bottom-0">
              ...
              <img src="/img/logo-angular.png" alt="angular" />
              <img src="/img/logo-ionic.png" alt="ionic" />
            </CardFooter>
          </Card>
        </div>
        <div className="col-span-4 md:col-span-1">
        ...
        <div className="col-span-4 md:col-span-1">
          <Card className="rounded-none border-0 hover:-translate-y-1 duration-300 md:h-[500px]">
            ...
            <CardFooter className="md:absolute md:bottom-0">
              <img src="/img/logo-aws.png" alt="aws" />
              <img src="/img/logo-spring.png" alt="spring" />
