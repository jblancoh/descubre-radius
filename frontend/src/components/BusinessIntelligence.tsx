const BusinessIntelligence = () => {
    return (
        <div className="bg-[#AF0729] text-white pt-52 sm:pt-40 lg:pt-40 pb-20 ">
          <div className="max-w-7xl mx-auto text-center">
            <div className="relative">
              {/* Background text */}
              <div className="absolute lg:top-[-110%] sm:top-[-120%] top-[-170%] lg:left-[-3%] transform z-0">
                <h1 className="lg:text-[5.5rem] text-[4rem] font-bold text-[#ba2845] opacity-50 pl-16 md:whitespace-nowrap text-left">Business Intelligence</h1>
              </div>
              {/* Main title */}
              <h1 className="relative text-black lg:text-6xl text-5xl font-bold mb-6 z-10 text-left lg:pl-40 pl-24  ">Business Intelligence</h1>
            </div>
